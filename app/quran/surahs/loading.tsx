            ...
            <VerticalScrollParagraph>
                {Array(15).fill("").map((_, i) => (
                    <a href="!#" className="flex gap-5 w-full py-4 px-5 mt-5" key={"skelton" + i + 1}>
                        <span className="w-6 h-6 rounded-full inline-block  bg-stone-300 dark:bg-stone-800  mb-2 animate-pulse" ></span>

                        <span className="w-40 h-6 inline-block  bg-stone-300 dark:bg-stone-800 rounded mb-2 animate-pulse" ></span>
