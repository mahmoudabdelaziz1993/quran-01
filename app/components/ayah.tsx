...
export default function Ayah({
  ...
  return (
    <>
      ...
      >
        <div className="grid bg-zinc-50  dark:bg-zinc-950 rounded-xl motion-preset-bounce  motion-ease-spring-smooth  motion-safe:transition-colors 
 gap-4  max-w-screen-sm w-full mx-auto  p-8 place-items-center text-center  ">
          <div className="flex w-full">
            <IconButton onClick={() => setControlPanel(false)} className="active:motion-preset-pop motion-safe:transition-colors">
          ...
          <div className="p-2  flex gap-4 items-center">
            ...
            <PlayAyahButton className="active:motion-scale-in-75 motion-safe:transition-colors" ayahNo={ayahNo} surahNo={surahNo} />
          </div>
        </div>
      </div>
      <a
