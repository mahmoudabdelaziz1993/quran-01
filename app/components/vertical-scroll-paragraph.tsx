export default function VerticalScrollParagraph({ children }: { children: React.ReactNode }) {
    return (
        <div className="relative w-full h-[calc(100vh-80px)]    overflow-hidden rounded-lg  px-5   bg-zinc-100 dark:bg-zinc-900">
            ...
            <p className="relative !leading-extra-loose -tracking-normal md:text-3xl text-xl text-justify  w-full h-[calc(100vh-80px)] overflow-y-auto scrollbar-hide pb-8 py-12">
                {children}
